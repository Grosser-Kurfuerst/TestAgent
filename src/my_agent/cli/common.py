...
def tool_environment_overrides(env: Mapping[str, str]) -> dict[str, str]:
    keys = {
        ...
        "MY_AGENT_MEMORY_EVOLVER_DATASET_DIR",
        "AGENTCLI_MEMORY_EVOLVER_COLLECTION_ROUND",
        "MY_AGENT_MEMORY_EVOLVER_COLLECTION_ROUND",
        "AGENTCLI_MEMORY_EVOLVER_DATASET_SPLIT",
        "MY_AGENT_MEMORY_EVOLVER_DATASET_SPLIT",
        ...
        "AGENTCLI_EMBEDDING_MODEL",
        "MY_AGENT_EMBEDDING_MODEL",
        "AGENTCLI_EMBEDDING_REVISION",
        "MY_AGENT_EMBEDDING_REVISION",
        "AGENTCLI_POLICY_BACKEND",
        "MY_AGENT_POLICY_BACKEND",
        "AGENTCLI_POLICY_BASE_MODEL",
        "MY_AGENT_POLICY_BASE_MODEL",
        "AGENTCLI_POLICY_BASE_REVISION",
        "MY_AGENT_POLICY_BASE_REVISION",
        "AGENTCLI_POLICY_ADAPTER_PATH",
        "MY_AGENT_POLICY_ADAPTER_PATH",
        "AGENTCLI_POLICY_IDENTITY_MANIFEST",
        "MY_AGENT_POLICY_IDENTITY_MANIFEST",
        "AGENTCLI_POLICY_TOKENIZER_REVISION",
        "MY_AGENT_POLICY_TOKENIZER_REVISION",
        "AGENTCLI_POLICY_CHAT_TEMPLATE",
        "MY_AGENT_POLICY_CHAT_TEMPLATE",
        "AGENTCLI_POLICY_DTYPE",
        "MY_AGENT_POLICY_DTYPE",
        "AGENTCLI_POLICY_DEVICE",
        "MY_AGENT_POLICY_DEVICE",
        "AGENTCLI_MEMORY_EVOLVER_TOP_K_PER_TIER",
        "MY_AGENT_MEMORY_EVOLVER_TOP_K_PER_TIER",
        "AGENTCLI_MEMORY_EVOLVER_SELECTED_MAX_ITEMS",
        "MY_AGENT_MEMORY_EVOLVER_SELECTED_MAX_ITEMS",
